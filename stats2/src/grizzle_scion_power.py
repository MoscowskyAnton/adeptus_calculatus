...
if __name__ == '__main__':
    ...
    for name, (abilities, kwabilities) in test_scenarious.items():
        ...
        Grenade = ac_weapon.AC_WEAPON(24, 1, 3, 9, 2, 'd3', name = "Grenade")
        
        if name == 'FRFSRF' or name == 'BASE' or name == 'T_AIM':
        ...
        targets = [ac_unit.AC_UNIT(6, 4, 3, 0, 2, 6, 2, []),
                   ...
                   ac_unit.AC_UNIT(5, 5, 3, 4, 3, 6, 2, []),
                   ac_unit.AC_UNIT(5, 5, 3, 4, 3, 6, 2, [], ac_weapon.AC_WEAPON.IN_COVER),                   
        ...
        for target in targets:
            d.append(BigScionSquad._get_data_damage_single_target_with_wounds(target, 9.1, N))
        DATA.append(d)
    ...
    plt.title("Scion-bombs on different targets (volly+gren)")
    plt.show()
